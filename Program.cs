...
//     {
//         array[i] = Prompt($"Input element number {i+1} ");
//     }
//     return array;
// }
...
// PrintArray(array);
// Console.WriteLine($"Number of positive numbers is {CountPos(array)} ");
...
//     lineData[COEFFICIENT] = Prompt($"Input coefficient for {lineNumber} - ");
//     lineData[CONSTANT] = Prompt($"Input constant {lineNumber} - ");
//     return lineData;
// }
